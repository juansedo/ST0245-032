 ...
 * Contiene una operación para crear un árbol de decisión sobre un 
 * nodo raíz.
...
public final class TrainingDataset {
     ...
     * @param level Nivel del árbol en el que se está haciendo la partición.
     * @return Nodo raíz del árbol.
     */
    private Node createTree(Dataset dataset, int level) {
        ...
        try {
            ...
            Dataset s1 = new Dataset(), s2 = new Dataset();
            for (Data d : dataset) {
    ...
    /**
     * @return Cantidad más grande de nodos en un nivel del árbol.
     */
    public int getWidth() {
...
class Node {
    ...
    /**
     * Nivel del árbol en el que está ubicado este nodo.
     */
    public int level;
...
/**
 * Clase con métodos para hacer cálculos estadísticos usados por el algoritmo.
 * @author juansedo, LizOriana1409
 */
class Gain {
    /**
     ...
     * {@link Data}.
     * Hace parte de la fórmula de la ganancia de información y es la representación
     * numérica de la homogeneidad de los datos. Siendo cero el caso en que todos son
     * iguales y uno el caso en el que son mitad y mitad exactamente.
     ...
     */
    static double generalEntropy(Dataset dataset) throws Exception {
     ...
     */
    static double [] partialEntropy(Dataset dataset, DataType t) throws Exception {
        Dataset s1 = new Dataset(), s2 = new Dataset();
 ...
 * Su constructor tiene un color para su representación gráfica.
 * <ul>
...
/**
 * Clase que representa un conjunto de datos de tipo {@link Data}.
 * @author juansedo, LizOriana1409
 */
